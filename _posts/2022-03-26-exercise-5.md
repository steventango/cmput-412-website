...
TODO: A screen recording of rviz and your terminal showing the camera image
detecting the digit (i.e., bounding box around the detected digit) with the
correct digit and Apriltag location printed to the terminal window ○ You can
obey the following flow: detect digit -> stop driving-> print to terminal
location of tag and what digit is detected -> continue driving
